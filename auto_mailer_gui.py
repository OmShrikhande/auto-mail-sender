...
class AutoMailerApp:
    def __init__(self, root: tk.Tk):
        ...
        self.hourly_limit_var = tk.StringVar(value="20")
    ...
    def _build_ui(self):
        ...
        Label(frm, text="Hourly Limit (mails/hour)").grid(row=row, column=1, sticky="w", padx=(170, 0))
        Entry(frm, textvariable=self.hourly_limit_var, width=10).grid(row=row, column=1, sticky="w", padx=(350, 0))
        row += 1
    ...
    def _validate_inputs(self) -> EngineConfig:
        ...
        hourly_limit = int(self.hourly_limit_var.get().strip())
